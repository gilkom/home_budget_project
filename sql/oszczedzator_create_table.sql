...
CREATE TABLE public.budgets_monthly_goal (
	...
	owner bigint NOT NULL,
	CONSTRAINT budgets_monthly_goal_pk PRIMARY KEY (owner ,category_id_budgets_category,period_id_budgets_period)
...
CREATE TABLE public.budgets_balance (
	...
	period_id_budgets_period integer NOT NULL,
	owner bigint NOT NULL,
	CONSTRAINT budgets_balance_pk PRIMARY KEY (owner ,period_id_budgets_period)
